...
if (isset($_GET['id_wr'])) {
  ...
  $query = "SELECT * FROM wisata_religi WHERE id_wr='$id_wr'";
...
<head>
  ...
  <title>Admin - Edit Data Wisata Religi</title>
    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container-fluid px-4">
          <h1 class="mt-4">Edit Data Wisata Religi</h1>

          <!-- Form Edit Data Wisata Alam -->
          <div class="card-body">
            <form action="edit_wisata_religi.php" method="POST" enctype="multipart/form-data">
              <input type="hidden" name="id_wr" value="<?php echo $id_wr; ?>">
              <div class="box-input">
